...
4. Обновление Telegram-бота:
   - Клиентская сторона: клиенты могут получить свои конфиг файлы. Необходимо связать ID клиента телеграмм с именем клиента VPN в формате: `client_id:имя_клиента`.
