...
<details>
  <summary>Версия от 12.01.2025</summary>
    
   - Оптимизация шаблонов под мобильные приложения.
   - Оптимизация главной страницы, для обеспечения более быстрого входа.
   - Правка `ovpn.html`:
     + Добавлена страница "Статистика за месяц".
     + Добавлена страница "История подключений".
   - Правка `wg.html`:
     + Добавлен переключатель автоматического обновления данных в таблице
