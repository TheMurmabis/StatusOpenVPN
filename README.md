...
<details>
  <summary>Версия от 16.12.2024</summary>
    
   - Правка `ovpn.html`:
     + Добавлены столбцы отображения скорости клиента.
     + Добавлено чтение файла `antizapret-no-cipher-status.log`
...
3. Данные для OpenVPN считываются из следующих файлов из директории `/etc/openvpn/server/logs/`.
