...
<details>
  <summary>Правка от 08.04.2026</summary>

1. На страницах со статистикой добавлена возможность прокрутки и свайпа календаря.
2. Исправлено отображение итогов на странице статистики OpenVPN.
3. На странице «Клиенты» добавлен порт сервера. Порт клиента отображается при наведении.
