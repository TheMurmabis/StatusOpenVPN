...
<details>
  <summary>Версия от 02.12.2024</summary>
    
   + Исправлены ошибки в скрипте смены пароля администратора `change_passwd.sh`
   + Добавлено ограничение времени бездействия пользователя: сессия автоматически завершается после 5 минут без активности.
