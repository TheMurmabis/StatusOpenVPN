...
<details>
  <summary>Версия от 19.10.2025</summary>
...
2. OpenVPN:
    * Удалена галочка `Скрыть UNDEF`, все клиенты `UNDEF` теперь исключаются автоматически.
    * Таблицы растянуты на всю ширину страницы.
    * Добавлено поле фильтрации клиентов на страницах `История подключений` и `Статистика`.
    * Страница «Статистика» переделана под табличное отображение.
3. WireGuard:
    * На мобильных устройствах теперь отображаются все столбцы таблицы.
