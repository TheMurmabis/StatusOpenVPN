...
<details>
  <summary>Версия от 01.04.2025.</summary>
...
1. Прсмотр списка клиентов и получение конфиг-файлов.
...
1. Выведен IP-адрес в главное меню.
1. Получение всех возможных конфиг-файлов через список клиентов.
1. Сокращение имени файла для Wireguard/AmneziaWG.
1. Удаление всех конфиг файлов клиента, после удаления клиента.
