...
<details>
  <summary>Правка от 03.08.2026</summary>

### StatusOpenVPN
1. Добавлено чтение статуса OpenVPN через management-сокет (`socat`), если status-файлы отсутствуют.
2. Общий кэш ответов socat хранится в `ovpn-status/`.
